...
Source Database       : ddpms

Target Server Type    : MYSQL
Target Server Version : 50524
File Encoding         : 65001

Date: 2013-02-26 23:03:12
*/
...
-- ----------------------------
-- Records of dd_category
-- ----------------------------

-- ----------------------------
-- Table structure for `dd_class`
-- ----------------------------
DROP TABLE IF EXISTS `dd_class`;
...
-- ----------------------------
DROP TABLE IF EXISTS `dd_groups`;
...
INSERT INTO `dd_node` VALUES ('40', 'Index', '我的首页', '1', '', '1', '0', '1', '0', '2');
...
INSERT INTO `dd_node` VALUES ('30', 'Public', '模块管理', '1', '', '4', '1', '2', '0', '0');
INSERT INTO `dd_node` VALUES ('7', 'User', '用户管理', '1', '', '3', '1', '2', '0', '2');
INSERT INTO `dd_node` VALUES ('6', 'Role', '角色管理', '1', '', '2', '1', '2', '0', '2');
INSERT INTO `dd_node` VALUES ('2', 'Node', '节点管理', '1', '', '1', '1', '2', '0', '2');
INSERT INTO `dd_node` VALUES ('1', 'Admin', '系统管理', '1', '', '6', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('50', 'main', '空白首页', '1', '', null, '40', '3', '0', '0');
INSERT INTO `dd_node` VALUES ('85', 'Materials', '原料管理', '1', '原料管理', null, '0', '2', '0', '2');
INSERT INTO `dd_node` VALUES ('3', 'Purchase', '采购管理', '1', '采购相关', '2', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('4', 'Stock', '库存管理', '1', '管理入库,出库', '3', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('5', 'Product', '产品管理', '1', '产品管理', '5', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('8', 'Sales', '销售管理', '1', '产品销售相关', '4', '0', '1', '0', '0');
INSERT INTO `dd_node` VALUES ('87', 'node_add', '添加', '1', '添加节点', null, '2', '3', '0', '2');
INSERT INTO `dd_node` VALUES ('88', 'Node_del', '删除节点', '1', '辐射大沙发沙发', null, '3', '1', '0', '2');

-- ----------------------------
-- Table structure for `dd_provider`
-- ----------------------------
DROP TABLE IF EXISTS `dd_provider`;
...
-- ----------------------------
-- Records of dd_supplier_contacts
-- ----------------------------
...
-- Records of dd_user
-- ----------------------------
INSERT INTO `dd_user` VALUES ('1', 'admin', '管理员', '21232f297a57a5a743894a0e4a801fc3', '', '1361888242', '127.0.0.1', '934', '8888', 'liu21st@gmail.com', '备注信息', '1222907803', '1239977420', '1', '0', '');
...
Target Database: ddpms
Date: 2013/2/27 18:28:14
*/
...
-- ----------------------------
-- Table structure for dd_node_bak
-- ----------------------------
CREATE TABLE `dd_node_bak` (
...
INSERT INTO `dd_groups` VALUES ('2', '项目组2');
INSERT INTO `dd_groups` VALUES ('3', '项目组3');
INSERT INTO `dd_node` VALUES ('1', 'Purchase', '采购管理', '1', '采购相关的管理', '1', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('2', 'Stocks', '库存管理', '1', '入库，出库，库存查询', '2', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('3', 'Materials', '原料管理', '1', '原料管理', '3', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('4', 'Product', '产品管理', '1', '产品相关', '3', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('5', 'Salse', '销售管理', '1', '销售相关管理', '4', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('6', 'System', '系统管理', '1', '系统其它设置', '6', '0', '1', '0', '2');
INSERT INTO `dd_node` VALUES ('7', 'Node', '节点管理', '1', '添加，删除，修改节点', '1', '6', '2', '0', '2');
INSERT INTO `dd_node` VALUES ('8', 'User', '用户管理', '1', '用户管理', '2', '6', '2', '0', '2');
INSERT INTO `dd_node` VALUES ('9', 'Role', '角色管理', '1', '角色管理', '3', '6', '2', '0', '2');
INSERT INTO `dd_node_bak` VALUES ('49', 'read', '查看', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('40', 'Index', '我的首页', '1', '', '1', '1', '2', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('39', 'index', '列表', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('37', 'resume', '恢复', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('36', 'forbid', '禁用', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('35', 'foreverdelete', '删除', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('34', 'update', '更新', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('33', 'edit', '编辑', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('32', 'insert', '写入', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('31', 'add', '新增', '1', '', null, '30', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('30', 'Public', '我的首页', '1', '', '10', '1', '2', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('7', 'User', '用户管理', '1', '', '4', '1', '2', '0', '2');
INSERT INTO `dd_node_bak` VALUES ('6', 'Role', '角色管理', '1', '', '3', '1', '2', '0', '2');
INSERT INTO `dd_node_bak` VALUES ('2', 'Node', '节点管理', '1', '', '2', '1', '2', '0', '2');
INSERT INTO `dd_node_bak` VALUES ('1', 'system', '系统管理', '1', '系统所有的所有的设置', '8', '0', '1', '0', '2');
INSERT INTO `dd_node_bak` VALUES ('50', 'main', '空白首页', '1', '', null, '40', '3', '0', '0');
INSERT INTO `dd_node_bak` VALUES ('85', 'Materials', '原料管理', '1', '原料管理', '1', '0', '1', '0', '2');
INSERT INTO `dd_provider` VALUES ('1', '三星', '1', '北京', '三星负责人', '12302215', '22112', '012011', 'http://www.sunsung.com', 'sss@123.com', '0', '0');
INSERT INTO `dd_provider` VALUES ('2', 'sony', '1', 'bejing', 'sony', '112222', '36652', '201001', 'http://google.com', 'test2@123.com', '0', '0');
INSERT INTO `dd_provider` VALUES ('3', 'dell', '1', 'tianjing', 'dell', '56242', '232245', '22222', 'http://www.163.com', 'sfasf', '0', '0');
INSERT INTO `dd_role` VALUES ('1', '领导组', '0', '1', '', '', '1208784792', '1254325558');
...
INSERT INTO `dd_role_user` VALUES ('3', '35');
INSERT INTO `dd_role_user` VALUES ('3', '36');
INSERT INTO `dd_user` VALUES ('1', 'admin', '管理员', '21232f297a57a5a743894a0e4a801fc3', '', '1361930055', '127.0.0.1', '939', '8888', 'liu21st@gmail.com', '备注信息', '1222907803', '1239977420', '1', '0', '');
INSERT INTO `dd_user` VALUES ('2', 'demo', '演示', 'fe01ce2a7fbac8fafaed7c982a04e229', '', '1306159437', '127.0.0.1', '94', '8888', '', '', '1239783735', '1254325770', '1', '0', '');
INSERT INTO `dd_user` VALUES ('3', 'member', '员工', 'aa08769cdcb26674c6706093503ff0a3', '', '1254326104', '127.0.0.1', '15', '', '', '', '1253514375', '1254325728', '1', '0', '');
INSERT INTO `dd_user` VALUES ('4', 'leader', '领导', 'c444858e0aaeb727da73d2eae62321ad', '', '1284542339', '127.0.0.1', '17', '', '', '领导', '1253514575', '1254325705', '1', '0', '');
INSERT INTO `dd_user` VALUES ('36', 'zhanghuihua', '张慧华', '21218cca77804d2ba1922c33e0151105', '', '0', null, '0', null, 'zhanghuihua@sohu.com', '', '1284448629', '1285638494', '1', '0', '');
>>>>>>> 3869d550447cb35d526dae3ed05f5b2637983805
